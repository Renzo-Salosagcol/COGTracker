...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <button onClick={handleClick} className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition duration-300 hover:cursor-pointer">Get Started</button>
      <form>
