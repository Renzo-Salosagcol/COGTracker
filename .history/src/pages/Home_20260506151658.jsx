...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <button onClick={handleClick} className="bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition duration-300 cursor-pointer:hover">Get Started</button>
      <form>
        <button type="button" onClick={handleClick} className="bg-secondary text-white px-6 py-3 rounded-lg hover:bg-secondary-dark transition duration-300 mt-4">Test API Call</button>
      </form>
    </div>
  )
}